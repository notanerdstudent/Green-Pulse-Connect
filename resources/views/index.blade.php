    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="" class="nav__logo">
                <i class="ri-leaf-line nav__logo-icon"></i> GreenPlusConnect
            </a>
            ...
            <div class="steps__bg">
                ...
                <div class="steps__container grid">
                    ...
                    <div class="steps__card">
                        ...
                        <p class="steps__card-description">
                            Our delivery process is easy, you receive the
                            plant direct to your door.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="footer__container container grid">
            ...
            <div class="footer__content">
                ...
                <ul class="footer__data">
                    <li class="footer__information">Rohini</li>
                    <li class="footer__information">New Delhi - 110086</li>
                </ul>
            </div>
            ...
            <div class="footer__content">
                ...
                <ul class="footer__data">
                    <li class="footer__information">+9910526475</li>
