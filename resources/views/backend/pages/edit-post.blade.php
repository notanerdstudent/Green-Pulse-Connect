...
@section('content')
    ...
    <form action="{{route('author.posts.update-post',['post_id'=>Request('post_id')])}}" method="POST" id="editPostForm" enctype="multipart/form-data" class="mt-3"> 
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-9">
                        <div class="mb-3">
                            ...
                            <input type="text" name="post_title" class="form-control" placeholder="Please Enter Post Title" value="{{$post->post_title}}">
                            <span class="text-danger error-text post_title_error"></span>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Post Content</label>
                            <textarea name="post_content" id="post_content" class="ckeditor form-control" rows="6" placeholder="Post Content....">{!! $post->post_content !!}</textarea>
